...
|                                                                                |                                                                          |
| -   Strings - slicing, splitting, case                                         | -   Data Visualization - `ggplot2`                                       |
|                                                                                |                                                                          |
...
2.  Create a new `.Rmd` file or `.R` script inside `project_dir` to do the following:
    ...
    -   Save your plot(s) as `.png` file(s) in `project_dir/` with an informative file name (ex. "prevalence_by_treatment_rate.png")

#### Part 3. Submit to Slack

Post your plot(s) to the slack channel for feedback.
