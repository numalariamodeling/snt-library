...
Encountering errors in programming is inevitable and part of the learning process. They provide a learning opportunity and while annoying should not be seen as discouragement to continue. It is always good to try to resolve any issues yourself, however if it takes too much time, do not hesitate to ask for help. Many of the issues have been encountered by others as well and can be resolved in no time!
...
-   Web Search (*Python, R, git*)
-   Example Exercises (*EMOD*)
-   EMOD How-To Guides
-   Search the Help channel on Slack
